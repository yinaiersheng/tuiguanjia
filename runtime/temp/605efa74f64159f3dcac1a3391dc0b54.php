<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"/www/users/HA552655/WEB/public/../application/admin/view/index/index.html";i:1536636085;s:63:"/www/users/HA552655/WEB/application/admin/view/common/meta.html";i:1536636085;s:65:"/www/users/HA552655/WEB/application/admin/view/common/header.html";i:1536636085;s:63:"/www/users/HA552655/WEB/application/admin/view/common/menu.html";i:1536636085;s:66:"/www/users/HA552655/WEB/application/admin/view/common/control.html";i:1536636085;s:65:"/www/users/HA552655/WEB/application/admin/view/common/script.html";i:1536636085;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
...
<!-- /.control-sidebar -->
        ...
        <!-- 加载JS脚本 -->
        <script src="/public/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/public/assets/js/require-backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script>
    </body>
</html>